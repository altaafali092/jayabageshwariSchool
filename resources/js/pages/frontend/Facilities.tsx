...
import {
    ...
    Dumbbell, MapPin, Plus, ArrowRight, Library, Bed, GraduationCap
} from 'lucide-react';
...
export default function Facilities({ Categories, facilityCategory }: FacilitiesProps) {
    ...
    return (
        <FrontLayout>
            <Head title="Facilities | Jaya Bageshwori" />
                    ...
                    <div className="container mx-auto px-6 lg:px-20">
                        <div className="flex items-center gap-1 overflow-x-auto scrollbar-none justify-center lg:justify-start">
                            {Categories?.map((category) => {
                                const active = facilityCategory.slug === category.slug;
                                return (
                                    <Link
                                        key={category.slug}
                                        href={Facility(category.slug)}
                                        className={cn(
