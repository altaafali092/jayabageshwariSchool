            ...
            <main className="flex-1 bg-white dark:bg-slate-950 transition-colors duration-300">
                    ...
                    <div className="container mx-auto px-6 lg:px-20">
                        <div className="flex items-center justify-center lg:justify-between">
                            ...
                            <div className="lg:hidden w-full relative">
                                ...
                                >
                                    {tabs.map(tab => <option key={tab} value={tab} className="bg-white dark:bg-slate-900">{tab}</option>)}
                                </select>
                                <ChevronDown className="absolute right-6 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-400 pointer-events-none" />
                            </div>

                            <Link href="/admissions" className="hidden lg:flex items-center gap-3 text-[10px] font-black text-blue-600 dark:text-blue-400 uppercase tracking-widest hover:gap-5 transition-all">
                ...
                <div className="min-h-[600px]">
                                        ...
                                        {mainFacilities.map((facility, i) => (
                                            <div key={i} className={`flex flex-col lg:flex-row items-center gap-16 ${i % 2 !== 0 ? 'lg:flex-row-reverse' : ''}`}>
                                                <div className="flex-1 space-y-8">
                                                    ...
                                                    <button className="flex items-center gap-4 text-xs font-black text-slate-900 dark:text-white uppercase tracking-widest group italic">
                                                        View Gallery <div className="w-10 h-10 rounded-full border border-slate-200 dark:border-slate-800 flex items-center justify-center group-hover:bg-blue-600 dark:group-hover:bg-blue-500 group-hover:text-white transition-all"><ArrowRight className="w-4 h-4" /></div>
                                                    </button>
                                                </div>
                                                <div className="flex-1 relative w-full aspect-4/3 rounded-4xl overflow-hidden shadow-2xl shadow-blue-900/10 dark:shadow-black/50 group">
                            ...
                            <section className="py-24 bg-slate-50 dark:bg-slate-900 transition-colors">
                                <div className="container mx-auto px-6 lg:px-20">
                                    <div className="text-center mb-16 space-y-4">
                                        ...
                                        <p className="text-slate-500 dark:text-slate-400 font-bold text-xs lg:text-sm uppercase tracking-widest">Everything your child needs for a balanced educational journey</p>
                                    </div>
                                        ...
                                        {lifestyles.map((item, i) => (
                                            <div key={i} className="group p-10 rounded-[2.5rem] bg-white dark:bg-slate-950 border border-slate-100 dark:border-slate-800 hover:bg-blue-600 dark:hover:bg-blue-600 transition-all duration-500 shadow-xl shadow-slate-950/2 dark:shadow-black/20 hover:shadow-2xl hover:shadow-blue-600/20">
                                                <div className="flex items-start justify-between mb-8">
                                                    <div className="w-14 h-14 rounded-2xl bg-slate-50 dark:bg-slate-900 flex items-center justify-center text-slate-400 dark:text-slate-500 group-hover:bg-white/20 dark:group-hover:bg-white/20 group-hover:text-white transition-all">
                                                        <item.icon className="w-6 h-6" />
                                                    </div>
                                                    <Plus className="w-6 h-6 text-slate-200 dark:text-slate-800 group-hover:text-white/40 transition-colors" />
                                                </div>
                                                <div className="space-y-1">
                                                    <p className="text-[10px] font-black text-blue-600 dark:text-blue-400 uppercase tracking-widest group-hover:text-white/60 dark:group-hover:text-white/60 transition-colors">{item.category}</p>
                                                    <h4 className="text-xl font-black text-slate-900 dark:text-white uppercase italic tracking-tight group-hover:text-white transition-colors">{item.name}</h4>
                                                </div>
                                            </div>
                                        ))}
                                    </div>
                                    ...
                                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center mb-32">
                                        <div className="space-y-10">
                                            <div className="space-y-6">
                                                ...
                                                <p className="text-lg font-bold text-slate-500 dark:text-slate-400 leading-relaxed uppercase tracking-tight">
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                                {[
                                                    ...
                                                    <div key={i} className="p-6 rounded-3xl bg-slate-50 dark:bg-slate-900 border border-slate-100 dark:border-slate-800 hover:bg-white dark:hover:bg-slate-800 hover:shadow-xl dark:hover:shadow-black/50 transition-all duration-300">
                                                        <box.icon className="w-8 h-8 text-blue-600 dark:text-blue-400 mb-4" />
                                                        <h4 className="text-lg font-black text-slate-900 dark:text-white uppercase italic tracking-tight mb-2">{box.title}</h4>
                                                        <p className="text-xs font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest">{box.desc}</p>
                                                    </div>
                                                ))}
                                            </div>
                                        </div>
                    ...
                    {activeTab === 'Transportation' && (
                        <div className="animate-in fade-in slide-in-from-bottom-4 duration-700">
                            <section className="py-24 bg-slate-50/50 dark:bg-slate-900/50 transition-colors">
                                <div className="container mx-auto px-6 lg:px-20">
                                    <div className="flex flex-col lg:flex-row gap-20 items-center">
                                        <div className="flex-1 relative order-2 lg:order-1">
                                            <div className="grid grid-cols-2 gap-4">
                                                <div className="space-y-4">
                                                    ...
                                                    <img src="https://images.unsplash.com/photo-1544620347-c4fd4a3d5957?q=80&w=600&auto=format&fit=crop" className="aspect-square rounded-4xl object-cover shadow-xl dark:shadow-black/50" alt="" />
                                                </div>
                                                <div className="space-y-4 pt-12">
                                                    <img src="https://images.unsplash.com/photo-1570129477492-45c003edd2be?q=80&w=600&auto=format&fit=crop" className="aspect-square rounded-4xl object-cover shadow-xl dark:shadow-black/50" alt="" />
                                        ...
                                        <div className="flex-1 space-y-10 order-1 lg:order-2">
                                            <div className="space-y-6">
                                                <span className="text-[10px] font-black text-blue-600 dark:text-blue-500 uppercase tracking-[0.3em]">RELIABLE & PUNCTUAL</span>
                                                <h2 className="text-5xl lg:text-7xl font-black text-slate-900 dark:text-white uppercase italic tracking-tighter leading-none">
                            ...
                            <section className="py-24 bg-white dark:bg-slate-950 transition-colors overflow-hidden">
                                <div className="container mx-auto px-6 lg:px-20">
                                    <div className="text-center mb-24 space-y-6">
                                        <h2 className="text-5xl lg:text-7xl font-black text-slate-900 dark:text-white uppercase italic tracking-tighter">
                                            CHAMPIONS <span className="text-blue-600 dark:text-blue-500">HUB</span>
                                        </h2>
                                        <p className="text-lg font-bold text-slate-500 dark:text-slate-400 max-w-3xl mx-auto leading-relaxed uppercase tracking-tight">
                ...
                {/* ================= FINAL CTA ================= */}
                <section className="py-24 bg-white dark:bg-slate-950 transition-colors text-center">
