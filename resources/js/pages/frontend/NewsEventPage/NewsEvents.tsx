...
const NewsEvents = ({ newsEvents }: NewsEventProps) => {
    ...
    // Helper to get a single image path safely (picks a random one if it's an array)
    const resolveDisplayImage = (rawImage: any): string => {
        if (!rawImage) return '/placeholder-image.jpg'; // Fallback if no image exists
        ...
        // Pick a random image from the resolved array
    ...
    }, [activeCategory, searchQuery, newsEvents]);
                    ...
                    <div className="container mx-auto px-6 lg:px-20">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
                            {filteredNews.map((item) => {
                                // Dynamic execution: pick a random item link out of the collection array/string
                ...
                <section className="py-24 bg-blue-950">
                    <div className="container mx-auto px-6 lg:px-20 text-center">
                        ...
                        <form className="max-w-2xl mx-auto flex flex-col sm:flex-row gap-4">
                            ...
                            />
                            <button type="button" className="h-14 px-10 bg-blue-600 text-white font-black rounded-2xl flex items-center justify-center gap-3 hover:bg-white hover:text-blue-950 transition-all uppercase tracking-widest text-xs italic">
                                Subscribe
