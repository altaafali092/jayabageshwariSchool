                    ...
                    <div className="container mx-auto px-6 lg:px-20">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                            {reasons.map((reason, i) => (
                                <div key={i} className="group p-10 rounded-4xl bg-slate-50 border border-slate-100 hover:bg-white hover:shadow-2xl hover:shadow-blue-950/5 transition-all duration-500 relative overflow-hidden">
                                    <div className="relative z-10 space-y-6">
                                        <div className="w-16 h-16 rounded-3xl bg-white shadow-sm border border-slate-100 flex items-center justify-center text-slate-900 group-hover:bg-blue-600 group-hover:text-white transition-all duration-500">
                                            {reason.icon && <reason.icon className="w-7 h-7" />}
                                        </div>
                                        <div className="space-y-4">
                                            <h3 className="text-2xl font-black text-slate-900 uppercase italic tracking-tight">{reason.title}</h3>
                                    ...
                                    <div className="absolute top-10 right-10 opacity-5 group-hover:opacity-10 transition-opacity">
                                        {reason.icon && <reason.icon className="w-24 h-24" />}
                                    </div>
                                </div>
                            ))}
                        </div>
                    ...
                    <div className="container relative z-10 mx-auto px-6 lg:px-20">
                        <div className="max-w-4xl mx-auto text-center space-y-12">
                            ...
                            <div className="space-y-2">
                                <p className="text-[10px] font-black text-blue-400 uppercase tracking-[0.3em]">Arun Sharma</p>
                                <p className="text-[10px] font-black text-slate-500 uppercase tracking-widest italic">Alumni, Batch of 2018</p>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section className="py-24 bg-white border-b border-slate-100 text-center">
                    <div className="container mx-auto px-6 lg:px-20 space-y-16">
                        <h2 className="text-3xl lg:text-5xl font-black text-slate-900 uppercase italic tracking-tighter">
                            UNMATCHED <span className="text-blue-600">STANDARDS</span>
                        </h2>
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                            {[
                                ...
                                <div key={i} className="p-8 rounded-3xl bg-slate-50 border border-slate-100 space-y-3">
                ...
                <section className="py-24 bg-blue-600 text-center">
                    <div className="container relative z-10 mx-auto px-6 lg:px-20 space-y-10">
                        <h2 className="text-4xl lg:text-6xl font-black text-white uppercase italic tracking-tighter leading-tight">
                            CHOOSE THE <br />RIGHT PATH <br /><span className="text-slate-950">FOR YOUR FUTURE</span>
                        </h2>
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                            <Link href="/admissions" className="w-full sm:w-auto h-20 px-12 bg-slate-950 text-white rounded-4xl font-black text-xs uppercase tracking-widest hover:bg-white hover:text-slate-950 transition-all flex items-center justify-center gap-4 italic shadow-2xl shadow-black/20 group">
