    ...
    return (
        <FrontLayout>
            ...
            <main className="flex-1 bg-white">
                ...
                {/* ================= LEVEL SELECTOR ================= */}
                <section className="sticky top-[70px] lg:top-[80px] z-40 border-b border-slate-100 py-4 lg:py-0 shadow-lg shadow-blue-900/5 backdrop-blur-md bg-slate-50/90 overflow-hidden">
                    <div className="container mx-auto px-6 lg:px-20">
                        <div className="flex items-center justify-center lg:justify-between">
                            ...
                            <Link href="/admissions" className="hidden lg:flex items-center gap-3 text-[10px] font-black text-blue-600 uppercase tracking-widest hover:gap-5 transition-all italic">
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                                <div className="space-y-10">
                                    <div className="space-y-6">
                                        <p className="text-blue-600 font-black text-[10px] uppercase tracking-[0.3em]">{current.subtitle}</p>
                                        <h2 className="text-4xl lg:text-6xl font-black text-slate-900 uppercase italic tracking-tighter leading-none">
                                            EVERY CHILD HAS A <br /><span className="text-blue-600">UNIQUE SPARK</span>
                                        </h2>
                                    </div>
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                        {current.highlights.map((item, i) => (
                                            <div key={i} className="p-8 rounded-4xl bg-slate-50 border border-slate-100 space-y-4 hover:bg-white hover:shadow-2xl hover:shadow-blue-900/5 transition-all">
                                ...
                                <div className="relative">
                                    <div className="aspect-4/5 rounded-[4rem] overflow-hidden shadow-2xl shadow-blue-900/20 border-8 border-white group">
                                        <img
                                            src={
                                                activeTab === 'Primary'
                                    ...
                                    {activeTab !== 'Primary' && (
                                        <div className="absolute -bottom-10 -left-10 bg-slate-900 p-8 rounded-[3rem] shadow-2xl border border-white/10 space-y-4 max-w-[280px]">
                                            ...
                                            <p className="text-[9px] font-bold text-slate-400 uppercase tracking-widest leading-relaxed">Consistently ranked Top 3 in the regional academic standings.</p>
                                        </div>
                                    )}
                                </div>
                            </div>
                        ...
                        <div className="animate-in fade-in slide-in-from-bottom-4 duration-700">
                            ...
                            <section className="py-24 bg-slate-50">
                                <div className="container mx-auto px-6 lg:px-20 text-center mb-16 space-y-4">
                                    ...
                                    <p className="text-slate-500 font-bold text-xs lg:text-sm uppercase tracking-widest">Balanced academic program for holistic development</p>
                                </div>
                                <div className="container mx-auto px-6 lg:px-20">
                                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                                        {(current as any).curriculum.map((sub: any, i: number) => (
                                            <div key={i} className="group p-10 bg-white rounded-4xl border border-slate-100 shadow-xl shadow-slate-900/5 hover:-translate-y-2 transition-all duration-500">
                                                <div className="w-16 h-16 rounded-3xl bg-blue-50 text-blue-600 flex items-center justify-center mb-6 group-hover:bg-blue-600 group-hover:text-white transition-all">
                                                    <sub.icon className="w-7 h-7" />
                                                </div>
                                                <h4 className="text-xl font-black text-slate-900 uppercase italic tracking-tight mb-3">{sub.subject}</h4>
                                                <p className="text-xs font-bold text-slate-500 leading-relaxed uppercase tracking-tight">{sub.desc}</p>
                                            </div>
                                        ))}
                                    </div>
                                </div>
                                    ...
                                    <div className="max-w-4xl mx-auto">
                                        <div className="text-center mb-20 space-y-4">
                                            <h2 className="text-3xl lg:text-5xl font-black text-slate-900 uppercase italic tracking-tighter leading-none">
                                                A DAY IN <span className="text-blue-600">PRIMARY</span>
                                            </h2>
                                            <p className="text-slate-500 font-bold text-xs lg:text-sm uppercase tracking-widest">Structured activities for optimal learning & engagement</p>
                                        </div>
                                        <div className="space-y-4">
                                            {(current as any).dayInLife.map((step: any, i: number) => (
                                                <div key={i} className="group flex flex-col sm:flex-row items-center gap-8 p-8 bg-slate-50 rounded-3xl border border-slate-100 hover:bg-white hover:shadow-2xl hover:shadow-blue-900/5 transition-all">
                                                    <div className="px-6 py-2 bg-blue-600 text-white rounded-xl text-[10px] font-black uppercase tracking-widest italic shrink-0">
                                                        {step.time}
                                                    </div>
                                                    <p className="text-lg font-black text-slate-900 uppercase italic tracking-tight text-center sm:text-left">
                                                        {step.activity}
                                                    </p>
                                                </div>
                                            ))}
                                ...
                                <div className="container mx-auto px-6 lg:px-20 relative z-10">
                                    ...
                                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                                        {(current as any).streams.map((stream: any, i: number) => (
                                            <div key={i} className="p-12 rounded-[3.5rem] bg-white/5 border border-white/10 hover:bg-white/10 hover:border-blue-500/30 transition-all group">
                                                <div className="w-14 h-14 rounded-2xl bg-blue-600/20 text-blue-500 flex items-center justify-center mb-10 group-hover:bg-blue-600 group-hover:text-white transition-all">
                                                ...
                                                <p className="text-sm font-bold text-slate-400 leading-relaxed uppercase tracking-tight">{stream.desc}</p>
                                            </div>
                                        ))}
                                    </div>
                                </div>
                                    ...
                                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                                        ...
                                        <div className="space-y-10">
                                            <h2 className="text-3xl lg:text-5xl font-black text-slate-900 uppercase italic tracking-tighter leading-tight">
                                                WHY SECONDARY <br /> AT <span className="text-blue-600">JBS SCHOOL?</span>
                                            </h2>
                                            <div className="space-y-6">
                                                {(current as any).features.map((feature: any, i: number) => (
                                                    <div key={i} className="flex items-center gap-6 group">
                                                        <div className="w-12 h-12 rounded-2xl bg-blue-50 flex items-center justify-center text-blue-600 group-hover:bg-blue-600 group-hover:text-white transition-all shrink-0">
                                                            <CheckCircle2 className="w-5 h-5" />
                                                        </div>
                                                        <p className="text-lg font-black text-slate-900 uppercase italic tracking-tight">{feature}</p>
                                                    </div>
                                                ))}
                                            </div>
                                        </div>
                        ...
                        <div className="animate-in fade-in slide-in-from-bottom-4 duration-700">
                            ...
                            <section className="py-24 bg-slate-50">
                                <div className="container mx-auto px-6 lg:px-20">
                                    <div className="text-center mb-20 space-y-4">
                                        <h2 className="text-3xl lg:text-5xl font-black text-slate-900 uppercase italic tracking-tighter">
                                            CAREER <span className="text-blue-600">PATHWAYS</span>
                                        </h2>
                                        <p className="text-slate-500 font-bold text-xs lg:text-sm uppercase tracking-widest">Preparing students for diverse professional fields</p>
                                    </div>
                                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                                        {(current as any).pathways.map((path: any, i: number) => (
                                            <div key={i} className="p-10 bg-white rounded-4xl border border-slate-100 shadow-xl shadow-slate-900/5 hover:bg-blue-600 transition-all duration-500 group">
                                                <div className="w-14 h-14 rounded-2xl bg-blue-50 text-blue-600 flex items-center justify-center mb-8 group-hover:bg-white/20 group-hover:text-white transition-all">
                                                    <path.icon className="w-6 h-6" />
                                                </div>
                                                <h4 className="text-xl font-black text-slate-900 uppercase italic tracking-tight mb-2 group-hover:text-white transition-colors">{path.field}</h4>
                                                <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest group-hover:text-white/60 transition-colors leading-relaxed">{path.career}</p>
                                            </div>
                                        ))}
                                    </div>
                                </div>
                                ...
                                <div className="container mx-auto px-6 lg:px-20">
                                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                                        <div className="space-y-12">
                                            <h2 className="text-3xl lg:text-5xl font-black text-slate-900 uppercase italic tracking-tighter leading-tight">
                                                GLOBAL <span className="text-blue-600">STANDARDS</span> <br /> IN PEDAGOGY
                                            </h2>
                                            <div className="space-y-8">
                                                {(current as any).specializedStreams.map((stream: any, i: number) => (
                                                    <div key={i} className="p-10 border-l-4 border-blue-600 bg-slate-50 rounded-r-4xl space-y-2">
                                                        <h4 className="text-2xl font-black text-slate-900 uppercase italic tracking-tight">{stream.name}</h4>
                                                        <p className="text-sm font-bold text-slate-500 uppercase tracking-tight">{stream.details}</p>
                                                    </div>
                                                ))}
                                            </div>
                                        </div>
                    ...
                    <div className="container relative z-10 mx-auto px-6 lg:px-20 space-y-12">
                        <div className="space-y-4 text-center">
                            <h2 className="text-3xl lg:text-6xl font-black text-white uppercase italic tracking-tighter leading-none">
                                SECURE YOUR <br /> <span className="text-blue-500">ACADEMIC FUTURE</span>
                            </h2>
                            <p className="text-slate-500 font-bold text-xs lg:text-sm uppercase tracking-widest max-w-2xl mx-auto">Take the first step towards excellence by enrolling in our 2026-27 session. Limited seats available for specialized streams.</p>
                        </div>
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                            ...
                            <Link href="/contact" className="w-full sm:w-auto h-20 px-12 bg-white/5 border border-white/10 text-white rounded-4xl font-black text-sm uppercase tracking-widest hover:bg-white hover:text-slate-950 transition-all flex items-center justify-center gap-4 italic shadow-2xl">
                                Request Prospectus
                            </Link>
                        </div>
                    </div>
