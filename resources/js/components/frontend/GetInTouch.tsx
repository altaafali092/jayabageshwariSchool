...
const GetInTouch = () => {
    return (
        <section className="relative py-20 lg:py-8 flex items-center justify-center overflow-hidden bg-white dark:bg-slate-950 transition-colors duration-300">
            ...
            <div
                className="absolute inset-0 bg-fixed bg-center bg-cover opacity-25 dark:opacity-10 grayscale-[0.3]"
                style={{
            ...
            {/* Clean Light Overlay */}
            <div className="absolute inset-0 bg-linear-to-b from-white/90 via-blue-50/30 to-white/90 dark:from-slate-950/90 dark:via-slate-900/30 dark:to-slate-950/90 z-10" />
            ...
            <div className="container relative z-20 mx-auto px-2 text-center">
                <div className="max-w-4xl mx-auto space-y-12">
                    ...
                    <div className="space-y-6">
                        <span className="inline-block px-4 py-1.5 rounded-full bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400 text-[10px] font-bold uppercase tracking-[0.2em] border border-blue-100 dark:border-blue-800">
                            Admissions & Inquiries
                        </span>

                        <h2 className="text-4xl lg:text-6xl font-extrabold text-slate-900 dark:text-white tracking-tight">
                            We're Here to <span className="text-blue-600 dark:text-blue-500">Help You</span>
                        </h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-10 border-t border-slate-100 dark:border-slate-800 mt-10">
                        <div className="flex flex-col items-center gap-3">
                            <div className="w-12 h-12 rounded-full bg-blue-50 dark:bg-slate-900 flex items-center justify-center text-blue-600 dark:text-blue-400 border border-transparent dark:border-slate-800">
